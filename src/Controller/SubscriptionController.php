...
class SubscriptionController extends AbstractController
{
     ...
     * @Route("/", name="index")
     */
    public function index(Request $request, EntityManagerInterface $em, CompanyRepository $companyRepository): Response
    {
        $subscription = new Subscription();
        /** @var RegisteredUser */
        $registeredUser = $this->getUser()->getRegisteredUser();
