 ...
 * @UniqueEntity(fields={"email"}, message="Ce Mail est déjà utilisé. Essayez un autre Mail.")
 * @UniqueEntity(fields={"username"}, message="Username est déjà utilisé. Essayez un autre username.")
 */
