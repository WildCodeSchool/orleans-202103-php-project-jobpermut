 ...
 */
final class Version20210706093211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_523C9487A76ED395 ON testimony (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_523C9487A76ED395 ON testimony');
        $this->addSql('ALTER TABLE testimony ADD users_id INT NOT NULL, DROP user_id');
        $this->addSql('ALTER TABLE testimony ADD CONSTRAINT FK_523C948767B3B43D FOREIGN KEY (users_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
