 ...
 */
final class Version20210621090216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE registered_user (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, subscription_id INT DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, job_address VARCHAR(255) NOT NULL, ogr INT NOT NULL, username VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8B903F56A76ED395 (user_id), UNIQUE INDEX UNIQ_8B903F569A1887DC (subscription_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
